...
export const register = (req, res) => {
  ...
  db.query(q, req.body.username, (err, data) => {
    ...
    const q = "INSERT INTO guest_hosting_site_new.user_info(`username`,`full_name`, `password`,`security_1`, `security_2`, `security_3`,`status` , `total_reports` ,`is_account_ban`) VALUES (?)";
